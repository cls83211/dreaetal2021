...
fcort_DCvsDTlppp<-fcort_DCvsDT[which(fcort_DCvsDT$Preg.stage%in%c('(3) LP','(4) PP')),]
...
#Source code export
fcort_DCvsDTlpppexport= fcort_DCvsDTlppp[,c('Preg.Treatment','KMP.ID','Litter','fgcm.ng.g','Preg.stage','sample')]
#source code export
write.csv(fcort_DCvsDTlpppexport,'SupplementaryFigure6b_SourceData.csv')
...
qqnorm(res)
#ANOVA FOR REPORTED VALUES OF TRT CONDITION SINCE LAST APPEARANCE OF PREG TRT BEFORE FALLING OUT OF MODEL
